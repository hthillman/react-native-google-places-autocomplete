...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _onPress = (rowData) => {
    if (rowData.isPredefinedPlace !== true && this.props.fetchDetails === true) {
      ...
      request.open('GET', 'https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/details/json?' + Qs.stringify({
  ...
  _requestNearby = (latitude, longitude) => {
    ...
    if (latitude !== undefined && longitude !== undefined && latitude !== null && longitude !== null) {
      ...
      if (this.props.nearbyPlacesAPI === 'GoogleReverseGeocoding') {
        ...
        url = 'https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/geocode/json?' + Qs.stringify({
          latlng: latitude + ',' + longitude,
          key: this.props.query.key,
          ...this.props.GoogleReverseGeocodingQuery,
        });
      } else {
        url = 'https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/nearbysearch/json?' + Qs.stringify({
  ...
  _request = (text) => {
    ...
    if (text.length >= this.props.minLength) {
      ...
      request.open('GET', 'https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/autocomplete/json?&input=' + encodeURIComponent(text) + '&' + Qs.stringify(this.props.query));
      if (this.props.query.origin !== null) {
         request.setRequestHeader('Referer', this.props.query.origin)
      }
